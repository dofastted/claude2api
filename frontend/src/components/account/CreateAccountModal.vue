...
const buildOAuthExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
...
const handleAnthropicExchange = async (authCode: string) => {
  ...
  try {
    ...
    const extra: Record<string, unknown> = { ...(buildOAuthExtra(baseExtra) || {}) }
