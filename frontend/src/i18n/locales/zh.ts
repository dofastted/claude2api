  ...
  admin: {
    ...
    accounts: {
      ...
      environmentProfile: {
        ...
        claudeDesc: '按账号并发数生成环境 Profile 槽位，请求按 linux/windows/macos/desktop 绑定并复用匹配槽位。',
        codexTitle: 'Codex 环境 Profile 池',
        codexDesc: 'OpenAI OAuth/Codex 流量按请求环境使用并发槽位；槽位绑定后需重置才会重新绑定。',
        singleEnvironment: '环境 Profile 池',
        singleEnvironmentDesc: '开启后按账户等级自动使用 5/10/20 个 Profile 槽位；可用 environment_profile_manual_capacity 手动覆盖。',
        ...
        createPending: '创建账号时不会手动生成槽位；首次可信请求会生成或学习。',
