  ...
  admin: {
    ...
    accounts: {
      ...
      environmentProfile: {
        ...
        singleEnvironmentDesc: 'When enabled, account concurrency becomes the available profile-slot capacity.',
        ...
        allowDesktopLearnDesc: 'Only applies while the Claude slot is unbound.',
        allowOfficialClientLearn: 'Allow official client first-learn',
        allowOfficialClientLearnDesc: 'Only applies while the Codex slot is unbound.',
