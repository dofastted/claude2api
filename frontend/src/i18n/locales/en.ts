export default {
  ...
  // Setup Wizard
  setup: {
    title: 'claude2api Setup',
    description: 'Configure your claude2api instance',
    database: {
  ...
  admin: {
    claudeOAuthPools: {
      ...
      description: 'Manage migration policy, egress, shadow metrics, and enforcement. Environment capsules are auto-generated and bound to each OAuth credential — not configured here.',
      createPool: 'Create Pool',
      empty: 'No Claude OAuth pools configured.',
      status: 'Status',
      capsule: 'Capsule',
      capsuleAuto: 'Auto (per credential)',
      capsuleAutoNote: 'Each Claude OAuth credential automatically binds Windows / macOS / Linux environment capsules; missing bundles are ensured on enrollment.',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. claude2api-backups), choose a region',
    ...
    accounts: {
      ...
      environmentProfile: {
        claudeTitle: 'Claude environment profile pool',
        claudeDesc: 'Creates profile slots from account concurrency. Requests bind and reuse slots by linux/windows/macos/desktop.',
        codexTitle: 'Codex environment profile pool',
        codexDesc: 'OAuth Codex traffic uses request-environment slots; reset the pool to rebind a slot.',
        singleEnvironment: 'Environment profile pool',
        singleEnvironmentDesc: 'When enabled, account tier automatically selects 5/10/20 profile slots; environment_profile_manual_capacity can override it.',
        ...
        allowDesktopLearn: 'Allow Desktop learning',
        allowDesktopLearnDesc: 'Default off. When enabled, only standard Claude Desktop can write a fixed profile.',
        allowOfficialClientLearn: 'Allow official client learning',
        allowOfficialClientLearnDesc: 'Default off. When enabled, only standard Codex CLI/Desktop/VSCode can write a fixed profile.',
        editSlot: 'Edit slot',
        slotWindows: 'Windows slot',
        slotMacos: 'macOS slot',
        slotLinux: 'Linux slot',
        deviceId: 'Device ID',
        clientId: 'Client ID',
        platform: 'Platform',
        arch: 'Arch',
        ...
        slotSaveSuccess: 'Slot profile saved',
        slotSaveFailed: 'Failed to save slot profile',
        status: 'Current profile',
        poolStatus: 'Profile pool: {count}/{capacity} bound',
        slotTitle: 'Slot {slot} · {environment}',
        createPending: 'New credentials pre-generate 3 slots; unbound credentials lazily generate on first request.',
        noProfile: 'No profile or slot saved yet.',
        reset: 'Reset profile',
        resetting: 'Resetting...',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another claude2api instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for claude2api end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for claude2api end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'claude2api',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'Local-first AI API gateway',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'claude2api',
        useTls: 'Use TLS',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to claude2api',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">claude2api is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of claude2api, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to claude2api',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the claude2api AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
