//go:build wireinject && slim
// +build wireinject,slim
...
import (
	...
	"github.com/dofastted/claude2api/ent"
	...
	"github.com/dofastted/claude2api/internal/server"
...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	wire.Build(
		...
		// Application struct
		wire.Struct(new(Application), "Server", "Cleanup", "VersionFetcherService"),
	)
	return nil, nil
}
