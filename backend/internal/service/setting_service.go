...
const DefaultOpenAICodexUserAgent = "codex-tui/" + clientidentity.MinimumCodexCLIVersion + " (Ubuntu 22.4.0; x86_64) xterm-256color (codex-tui; " + clientidentity.MinimumCodexCLIVersion + ")"
...
func (s *SettingService) IsSimpleMode() bool {
...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteName:                         s.getStringOrDefault(settings, SettingKeySiteName, "claude2api"),
		SiteLogo:                         settings[SettingKeySiteLogo],
		SiteSubtitle:                     s.getStringOrDefault(settings, SettingKeySiteSubtitle, "Local-first AI API gateway"),
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	// cch_signing=false, claude_oauth_system_prompt_injection=false)
