...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/dofastted/claude2api/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/dofastted/claude2api/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 claude2api 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the claude2api Deployment and Operation Compliance Commitment"
