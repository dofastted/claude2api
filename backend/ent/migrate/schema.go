...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "local_intercept", Type: field.TypeBool, Default: false},
		{Name: "intercept_type", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_local_intercept_created_at",
				Unique:  false,
