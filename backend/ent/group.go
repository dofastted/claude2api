...
type Group struct {
	...
	// Strict Anthropic OAuth pool used by this group
	OauthPoolID *int64 `json:"oauth_pool_id,omitempty"`
...
type GroupEdges struct {
	...
	// OauthPool holds the value of the oauth_pool edge.
	OauthPool *OAuthPool `json:"oauth_pool,omitempty"`
...
// OauthPoolOrErr returns the OauthPool value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e GroupEdges) OauthPoolOrErr() (*OAuthPool, error) {
	if e.OauthPool != nil {
		return e.OauthPool, nil
	} else if e.loadedTypes[6] {
		return nil, &NotFoundError{label: oauthpool.Label}
	}
	return nil, &NotLoadedError{edge: "oauth_pool"}
}
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldOauthPoolID, group.FieldRpmLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldOauthPoolID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field oauth_pool_id", values[i])
			} else if value.Valid {
				_m.OauthPoolID = new(int64)
				*_m.OauthPoolID = value.Int64
			}
...
// QueryOauthPool queries the "oauth_pool" edge of the Group entity.
func (_m *Group) QueryOauthPool() *OAuthPoolQuery {
	return NewGroupClient(_m.config).QueryOauthPool(_m)
}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.OauthPoolID; v != nil {
		builder.WriteString("oauth_pool_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
